...
public class UnitRepository implements Repository {
	...
	public void removeUnit(String unitType) throws ExecutionControl.NotImplementedException {
		...
		if (this.amountOfUnits.containsKey(unitType) && this.amountOfUnits.get(unitType) >= 1){
			int numOfUnitType = this.amountOfUnits.get(unitType);
			this.amountOfUnits.put(unitType, numOfUnitType - 1);
		} else {
